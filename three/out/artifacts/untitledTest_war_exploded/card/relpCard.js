...
cardManage.initList = function () {
    $("#cardList").bootstrapTable({
        url: "/GetDestoryCardServlet", //请求路径
        method: 'post', //请求方式(*)
        ...
        columns: [{
            ...
            formatter: function (value) {
                switch (value) {
                    case 2 :
                        return "<span class='label label-info'>销毁</span>";
...
cardManage.buttonOption = function (value, row, index) {
    var returnButton = [];
    returnButton.push('<button class="btn btn-info updatecard">补卡</button>');
