...
@WebServlet(name = "UpdateCardStatusServlet",urlPatterns = "/UpdateCardStatusServlet")
public class UpdateCardStatusServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            int a=cardService.updateCardStatus(cardId);
            if(a>0){
