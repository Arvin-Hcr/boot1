 ...
 * 这个是会员充值总数
 */
@WebServlet(name = "GetRechargeAmountServlet",urlPatterns = "/GetRechargeAmountServlet")
public class GetRechargeAmountServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Map<String, Object> nearOneTypeUser = statisticService.getRechargeAmount();
